...
async def promote_harsh(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("All Permissions 🚀", callback_data="promote_all")],
        [InlineKeyboardButton("Cancel ❌", callback_data="promote_cancel")]
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await update.message.reply_text("Bhai, Admin banna hai? Title kya chahiye soch le!", reply_markup=reply_markup)


async def demote_harsh(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("📉 Harsh ko uski aukaat dikha di gayi hai. Saare Admin rights chheen liye gaye!")
    except Exception as e:
